	...
	<div class="container" style="padding-bottom: 3%;">
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<table class="table table-bordered">
					<caption>주문 회원 정보</caption>
					<tbody>
						<tr>
							<th style="width: 150px;">아이디<span class="required">&nbsp;*</span></th>
							<td>
								<c:out value="${ user.username }" />
							</td>
						</tr>
						<tr>
							<th>가입일<span class="required">&nbsp;*</span></th>
							<td>
						...
						<tr>
							<th>휴대전화번호<span class="required">&nbsp;*</span></th>
							<td>
						...
						<tr>
							<th>계정상태<span class="required">&nbsp;*</span></th>
							<td>
